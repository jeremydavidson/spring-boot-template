package com.theloom.spring.boot.template.integration;
...
import com.theloom.spring.boot.template.filter.RequestIdFilter;
import com.theloom.spring.boot.template.model.dto.ErrorDto;
import com.theloom.spring.boot.template.model.dto.NewTemplateDto;
import com.theloom.spring.boot.template.model.dto.SearchResult;
...
import com.theloom.spring.boot.template.repository.TemplateRepository;
...
class TemplateControllerTest {
    ...
    void add() throws Exception {
        ...
        MvcResult result = mvc.perform(
                post(CREATE_URL).contentType(MediaType.APPLICATION_JSON)
